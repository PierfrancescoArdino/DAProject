...
public class DepoldOutputFormat<I extends WritableComparable,
    ...
    public TextVertexWriter createVertexWriter(TaskAttemptContext context) {
        return new DepoldVertexWriter();
    }

    /**
     * Vertex writer used with {@link DepoldOutputFormat}.
     */
    protected class DepoldVertexWriter extends TextVertexWriterToEachLine {
        /** Saved delimiter */
        ...
        protected Text convertVertexToLine(Vertex<I, V, E> vertex)
            ...
            THALS vertexValue = ((THALS) vertex.getValue());
            if (reverseOutput) {
